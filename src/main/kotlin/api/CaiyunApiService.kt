...
object CaiyunApiService {
    ...
    fun sendVerification(PhoneNumber: Long): String {
        ...
        val returnData: UserInfoData = Json.decodeFromString(jsonStr)
    ...
    fun loginFromCode(codeId: String, code: Int, PhoneNumber: Long): String {
        ...
        val jsonStr = getString(conn.inputStream)
        try {
            val userInfo: UserInfoData = Json.decodeFromString(jsonStr)
    ...
    private fun setConnection(Url: String): HttpsURLConnection {
        ...
        connection.setRequestProperty("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.55 Safari/537.36 Edg/96.0.1054.34")
        return connection
    }
